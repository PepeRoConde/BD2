...
\begin{itemize}
	...
	\item Depende o número de medios de accesibilidade do hospedador co seu tempo de resposta?
\end{itemize}
...
A nosa única métrica é o \emph{score} da reseña. Non é aditiva porque $\frac{3}{5} + \frac{4}{5} = \frac{7}{5}$ pero non ten sentido nin é posible scores de máis de 1. En cambio pode agregarse con \texttt{AVG}.
